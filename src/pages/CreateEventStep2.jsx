    ...
    <div className="create-event page">
      ...
      <main>
        ...
        <label>
          ...
          >
            <span className="value">
              {formatDateLabel(data.date) || "Vælg dato"}
            </span>
              ...
              >
                <button
                  onClick={() =>
                    setCalMonth(({ y, m }) => {
                      const mm = m - 1;
                      return { y: mm < 0 ? y - 1 : y, m: mm < 0 ? 11 : mm };
                    })
                  }
                >
                  {"<"}
                ...
                <div style={{ color: "var(--text-primary)", fontWeight: 600 }}>
                  {new Date(calMonth.y, calMonth.m, 1).toLocaleString("da-DK", {
                    month: "long",
                    year: "numeric",
                  })}
                </div>
                <button
                  onClick={() =>
                    setCalMonth(({ y, m }) => {
                      const mm = m + 1;
                      return { y: mm > 11 ? y + 1 : y, m: mm > 11 ? 0 : mm };
                    })
                  }
                >
                  {">"}
        ...
        <label>
          Tidspunkt
          <div
            className="row-field time-field"
          ...
          >
            <input
              ...
              onChange={(e) => {
                ...
                update({ startTime: s, endTime: "", time: s });
              }}
              style={{
