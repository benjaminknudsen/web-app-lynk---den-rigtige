    ...
    <div className="create-event page">
      ...
      <main>
        <p style={{ color: "var(--text-primary)" }}>
          Fortæl lidt mere så andre ved hvad de kan forvente
        </p>
        ...
        <div style={{ marginTop: 8 }}>
          ...
          <div className="level-row">
            <button
              className={
                "level-btn" + (selectedLevel === "Casual" ? " active" : "")
              }
              onClick={() => chooseLevel("Casual")}
            >
              <svg
                width="18"
                height="18"
              ...
              >
                ...
                />
                <path
                  d="M9 10.75C9 11.0815 8.8683 11.3995 8.63388 11.6339C8.39946 11.8683 8.08152 12 7.75 12C7.41848 12 7.10054 11.8683 6.86612 11.6339C6.6317 11.3995 6.5 11.0815 6.5 10.75C6.5 10.4185 6.6317 10.1005 6.86612 9.86612C7.10054 9.6317 7.41848 9.5 7.75 9.5C8.08152 9.5 8.39946 9.6317 8.63388 9.86612C8.8683 10.1005 9 10.4185 9 10.75ZM16.25 12C16.5815 12 16.8995 11.8683 17.1339 11.6339C17.3683 11.3995 17.5 11.0815 17.5 10.75C17.5 10.4185 17.3683 10.1005 17.1339 9.86612C16.8995 9.6317 16.5815 9.5 16.25 9.5C15.9185 9.5 15.6005 9.6317 15.3661 9.86612C15.1317 10.1005 15 10.4185 15 10.75C15 11.0815 15.1317 11.3995 15.3661 11.6339C15.6005 11.8683 15.9185 12 16.25 12Z"
                  fill="currentColor"
                />
              </svg>
              Casual
            ...
            <button
              className={
                "level-btn" + (selectedLevel === "Motion" ? " active" : "")
              }
            ...
            <button
              className={
                "level-btn" + (selectedLevel === "Seriøst" ? " active" : "")
              }
              onClick={() => chooseLevel("Seriøst")}
            >
              <svg
                width="18"
                height="18"
        ...
        <div style={{ marginTop: 10 }}>
          ...
          >
            ...
            >
              ...
              />
              <path
                d="M2 20c0-2.5 3-4 6-4h8c3 0 6 1.5 6 4v1H2v-1z"
                fill="currentColor"
              />
            </svg>
            <span style={{ fontWeight: 700, color: "var(--text-primary)" }}>
              {data.participants || 1} Deltagere
            </span>
            {editingParticipants && (
              <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
                <button
                  onClick={(e) => {
                    e.stopPropagation();
                    setLocalParticipants((p) => Math.max(1, p - 1));
                  }}
                  style={{
                ...
                <input
                  ...
                  onChange={(e) =>
                    setLocalParticipants(Number(e.target.value) || 0)
                  }
                  style={{
                    width: 56,
                    padding: 6,
                ...
                <button
                  onClick={(e) => {
                    e.stopPropagation();
                    update({ participants: localParticipants });
